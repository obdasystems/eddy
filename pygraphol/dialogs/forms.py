...
class CardinalityRestrictionForm(QDialog):
    ...
    """
    class CardinalityField(QLineEdit):
        """
        This class implements the input field where the user can enter the cardinality range value.
        """
        def __init__(self, parent=None):
            """
            Initialize the cardinality input field.
            """
    ...
    def __init__(self, parent=None):
        ...
        self.minCardinalityField = CardinalityRestrictionForm.CardinalityField(self)
        self.maxCardinalityField = CardinalityRestrictionForm.CardinalityField(self)
