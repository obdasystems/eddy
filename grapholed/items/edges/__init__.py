...
from grapholed.items.edges.inclusion import InclusionEdge
from grapholed.items.edges.input import InputEdge
from grapholed.items.edges.instance_of import InstanceOfEdge
