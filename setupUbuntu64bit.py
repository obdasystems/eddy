...
QT_BASE_PATH = '/home/obda/Qt/5.9/gcc_64/'
QT_LIB_PATH = '/home/obda/Qt/5.9/gcc_64/lib/'
QT_PLUGINS_PATH = '/home/obda/Qt/5.9/gcc_64/plugins/'
QT_SRC_PATH = '/home/obda/Qt/5.9/'
...
if MACOS:
    ...
    class BDistMac(cx_Freeze.bdist_mac):
        ...
        def find_qt_menu_nib(self):
            ...
            path = expandPath(os.path.join(QT_SRC_PATH, 'Src/qtbase/src/plugins/platforms/cocoa/qt_menu.nib'))
