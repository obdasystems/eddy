...
class IriWidget(QtWidgets.QScrollArea):
    ...
    def redraw(self):
        ...
        height_of_other_objects = self.entry_status.height()+self.entry_button.height()
