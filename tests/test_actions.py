...
class ActionsTestCase(EddyTestCase):
    ...
    def test_action_copy(self):
        ...
        node = first(self.project.predicates(Item.RoleNode, 'test:hasParent', diagram))
    ...
    def test_action_copy_and_paste_single_predicate_node_on_the_same_diagram(self):
        ...
        self.assertLen(2, self.project.predicates(Item.RoleNode, 'test:hasParent', diagram))
        self.assertLen(2, self.project.predicates(Item.RoleNode, 'test:hasParent'))
        self.assertFalse(self.session.clipboard.empty())
        self.assertEqual(self.session.clipboard.size(), 1)
    ...
    def test_action_copy_and_paste_multiple_predicate_nodes_on_the_same_diagram(self):
        ...
        action_copy = self.session.action('copy')
        action_paste = self.session.action('paste')
        node1 = first(self.project.predicates(Item.RoleNode, 'test:hasParent', diagram))
        node2 = first(self.project.predicates(Item.RoleNode, 'test:hasAncestor', diagram))
        node3 = first(self.project.predicates(Item.RoleNode, 'test:hasFather', diagram))
        node4 = first(self.project.predicates(Item.RoleNode, 'test:hasMother', diagram))
        num_items_in_project = len(self.project.items())
        num_nodes_in_project = len(self.project.nodes())
        num_edges_in_project = len(self.project.edges())
        num_nodes_in_diagram = len(diagram.nodes())
        ...
        self.assertLen(2, self.project.predicates(Item.RoleNode, 'test:hasParent', diagram))
        self.assertLen(2, self.project.predicates(Item.RoleNode, 'test:hasParent'))
        self.assertLen(2, self.project.predicates(Item.RoleNode, 'test:hasAncestor', diagram))
        self.assertLen(2, self.project.predicates(Item.RoleNode, 'test:hasAncestor'))
        self.assertLen(2, self.project.predicates(Item.RoleNode, 'test:hasFather', diagram))
        self.assertLen(2, self.project.predicates(Item.RoleNode, 'test:hasFather'))
        self.assertLen(2, self.project.predicates(Item.RoleNode, 'test:hasMother', diagram))
        self.assertLen(2, self.project.predicates(Item.RoleNode, 'test:hasMother'))
        self.assertFalse(self.session.clipboard.empty())
    ...
    def test_action_cut(self):
        ...
        self.assertEmpty(self.project.predicates(Item.RoleNode, 'test:hasParent', diagram))
        self.assertEmpty(self.project.predicates(Item.RoleNode, 'test:hasParent'))
        self.assertFalse(self.session.clipboard.empty())
        self.assertEqual(self.session.clipboard.size(), 1)
        self.assertFalse(self.session.undostack.isClean())
    ...
    def test_action_cut_and_paste_single_predicate_node_on_the_same_diagram(self):
        ...
        self.assertEqual(num_edges_in_project, len(self.project.edges(diagram)) + 3)
        self.assertLen(1, self.project.predicates(Item.RoleNode, 'test:hasParent', diagram))
        self.assertLen(1, self.project.predicates(Item.RoleNode, 'test:hasParent'))
        self.assertFalse(self.session.clipboard.empty())
        self.assertEqual(self.session.clipboard.size(), 1)
        self.assertFalse(self.session.undostack.isClean())
    ...
    def test_action_cut_and_paste_multiple_predicate_nodes_on_the_same_diagram(self):
        ...
        self.assertLen(1, self.project.predicates(Item.RoleNode, 'test:hasParent', diagram))
        self.assertLen(1, self.project.predicates(Item.RoleNode, 'test:hasParent'))
        self.assertLen(1, self.project.predicates(Item.RoleNode, 'test:hasAncestor', diagram))
        self.assertLen(1, self.project.predicates(Item.RoleNode, 'test:hasAncestor'))
        self.assertLen(1, self.project.predicates(Item.RoleNode, 'test:hasFather', diagram))
        self.assertLen(1, self.project.predicates(Item.RoleNode, 'test:hasFather'))
        self.assertLen(1, self.project.predicates(Item.RoleNode, 'test:hasMother', diagram))
        self.assertLen(1, self.project.predicates(Item.RoleNode, 'test:hasMother'))
        self.assertFalse(self.session.clipboard.empty())
        self.assertEqual(self.session.clipboard.size(), 4)
        self.assertFalse(self.session.undostack.isClean())
    ...
    def test_action_delete_multiple_predicate_nodes_with_shared_edges(self):
        ...
        self.assertEmpty(self.project.predicates(Item.RoleNode, 'test:hasParent', diagram))
        self.assertEmpty(self.project.predicates(Item.RoleNode, 'test:hasParent'))
        self.assertEmpty(self.project.predicates(Item.RoleNode, 'test:hasAncestor', diagram))
        self.assertEmpty(self.project.predicates(Item.RoleNode, 'test:hasAncestor'))
        self.assertEmpty(self.project.predicates(Item.RoleNode, 'test:hasFather', diagram))
        self.assertEmpty(self.project.predicates(Item.RoleNode, 'test:hasFather'))
        self.assertEmpty(self.project.predicates(Item.RoleNode, 'test:hasMother', diagram))
        self.assertEmpty(self.project.predicates(Item.RoleNode, 'test:hasMother'))
        self.assertFalse(self.session.undostack.isClean())
    ...
    def test_action_purge_role_node(self):
        ...
        node = first(self.project.predicates(Item.RoleNode, 'test:hasAncestor', diagram))
        num_items_in_project = len(self.project.items())
        num_nodes_in_project = len(self.project.nodes())
        num_edges_in_project = len(self.project.edges())
        num_nodes_in_diagram = len(diagram.nodes())
