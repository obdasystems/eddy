...
ACTION_SNAP_TO_GRID_S = 'Align the elements in the active diagram to the grid'
...
COMMAND_EDGE_TOGGLE_EQUIVALENCE = 'toggle {0} equivalence'
COMMAND_EDGE_TOGGLE_EQUIVALENCE_MULTI = 'toggle equivalence for {0} edges'
COMMAND_ITEM_ADD = 'add {0}'
COMMAND_ITEM_ADD_MULTI = 'add {0} items'
COMMAND_ITEM_EDIT_LABEL = 'edit {0} label'
COMMAND_ITEM_MOVE_LABEL = 'move {0} label'
COMMAND_ITEM_REMOVE = 'remove {0}'
COMMAND_ITEM_REMOVE_MULTI = 'remove {0} items'
COMMAND_ITEM_SET_PROPERTY = '{0}set {1} {2} property'
COMMAND_ITEM_SNAP = 'snap {0} item(s) to the grid'
...
INFO_KEY_EQUIVALENCE = 'Equivalence'
...
PROJECT_ERROR_MISSING_HOME = 'missing project home: {0}'
PROJECT_ERROR_MISSING_META = 'missing project metadata: {0}'
PROJECT_ERROR_MISSING_STRUCTURE = 'missing project structure: {0}'
PROJECT_IRI_LABEL = 'IRI'
PROJECT_LOADING = 'Loading project: {0}'
PROJECT_LOCATION_LABEL = 'Location'
PROJECT_NAME_LABEL = 'Name'
PROJECT_NOT_FOUND_MESSAGE = 'Project <b>{0}</b> not found!'
PROJECT_NOT_FOUND_WINDOW_TITLE = 'Project not found!'
PROJECT_NOT_VALID_MESSAGE = 'Project <b>{0}</b> is not valid!'
PROJECT_NOT_VALID_WINDOW_TITLE = 'Project not valid!'
