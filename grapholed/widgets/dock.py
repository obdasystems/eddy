...
from grapholed.functions import disconnect, connect
...
class Palette(QWidget):
    ...
    def initUI(self):
        ...
        self.addButton(UnionNode, 2, 2)
        self.addButton(EnumerationNode, 3, 0)
        self.addButton(ComplementNode, 3, 1)
        self.addButton(RoleChainNode, 3, 2)
        self.addButton(IntersectionNode, 4, 0)
        self.addButton(RoleInverseNode, 4, 1)
        self.addButton(DatatypeRestrictionNode, 4, 2)
    ...
    def addButton(self, item, row, col):
        ...
        :param item: the class of the item being added to the palette.
        :param row: the row index where to add the button.
        :param col: the col index where to add the button.
        """
        button = QToolButton()
        ...
        self.buttonById[item.itemtype] = button
        self.buttonGroup.addButton(button, item.itemtype)
