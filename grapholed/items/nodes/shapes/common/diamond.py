...
class Diamond(AbstractResizableNodeShape):
    """
    This class implements a resizable diamond.
    """
    indexL = 0
    indexB = 1
    indexT = 3
    ...
    def __init__(self, width=minW, height=minH, **kwargs):
        ...
        self.polygon = Diamond.createPolygon(max(width, self.minW), max(height, self.minH))
