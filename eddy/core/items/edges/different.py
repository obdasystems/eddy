...
class DifferentEdge(AbstractEdge):
    """
    This class implements the 'differentIndividuals' edge.
    """
    Type = Item.DifferentEdge
    ...
    def __init__(self, **kwargs):
        ...
        self.label = EdgeLabel('different', centered=True, parent=self)
